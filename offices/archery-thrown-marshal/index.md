...
Ever want to become the next Robin Hood, Katniss Everdeen, Merida or Legolas with a bow and arrows, or maybe throw axes, spears or knives? Then come join the Drachenwald Archery & Thrown Weapons community. Our activities are open to participants of all ages, and no previous experience is required.
...
* Drachenwald archery marshal´s handbook explaining safety rules, equipment guidelines and how to run tournaments within Drachenwald. ([Signed PDF version]({{ site.baseurl }}{% link offices/archery-thrown-marshal/files/drachenwald_target_archery_handbook_0.pdf %}))
...
* [Company aims and ranks]({{ site.baseurl }}{% link offices/archery-thrown-marshal/files/Drachenwald Company of Archers.pdf %})
